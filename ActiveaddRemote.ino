...
//manual btn or remote choose

remote control
#include <IRremote.h>  // need z3t0 IRromte.h
...
*/
   //remote turn on / off part

  if( irrecv.decode(&results) ) {
    switch(results.value) {   
      case 0xFF30CF : //push 1
      Serial.println("turn on");  //sirial Monitor Test operation 
      motor1.run(FORWARD);
      motor1.setSpeed(150);
      motor2.run(FORWARD);
      motor2.setSpeed(150);
      ...
      case 0xFF18E7 : //push 2
      Serial.println("turn off"); //sirial Monitor Test operation 
      motor1.run(RELEASE);   
      motor2.run(RELEASE);
      break;
    }
